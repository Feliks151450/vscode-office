...
console.log("\n=== 验证 ===");
const checks = {
    "包含 background-color:#fed7aa": afterMd.includes("background-color:#fed7aa"),
    "包含 color:#dc2626 (内层)": afterMd.includes("color:#dc2626"),
    "包含 '示例'": afterMd.includes("示例"),
    "包含 '页面'": afterMd.includes("页面"),
};
