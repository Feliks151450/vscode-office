!function(e, t) {
    ...
    w.extend = w.fn.extend = function() {
        ...
        a--); a < s; a++)
            if (null != (r = arguments[a]))
                for (n in r)
                    i = o[n],
                    o !== (t = r[n]) && (l && t && (w.isPlainObject(t) || (e = w.isArray(t))) ? (i = e ? (e = !1,
                    i && w.isArray(i) ? i : []) : i && w.isPlainObject(i) ? i : {},
    ...
    w.extend({
        ...
        makeArray: function(e, t) {
            t = t || [];
            return null != e && (d(Object(e)) ? w.merge(t, "string" == typeof e ? [e] : e) : s.call(t, e)),
            t
        },
    ...
    var p = function(n) {
        ...
        var e, d, x, o, t, p, h, m, w, u, c, g, T, r, y, v, i, a, b, C = "sizzle" + -new Date, N = n.document, E = 0, k = 0, s = ie(), S = ie(), l = ie(), A = function(e, t) {
            return e === t && (c = !0),
            0
        }, D = "undefined", j = {}.hasOwnProperty, L = [], H = L.pop, _ = L.push, q = L.push, M = L.slice, O = L.indexOf || function(e) {
            for (var t = 0, n = this.length; t < n; t++)
                if (this[t] === e)
                    return t;
            return -1
        }
        , F = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", B = "[\\x20\\t\\r\\n\\f]", P = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", R = P.replace("w", "w#"), W = "\\[" + B + "*(" + P + ")(?:" + B + "*([*^$|!~]?=)" + B + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + R + "))|)" + B + "*\\]", $ = ":(" + P + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + W + ")*)|.*)\\)|)", z = new RegExp("^" + B + "+|((?:^|[^\\\\])(?:\\\\.)*)" + B + "+$","g"), I = new RegExp("^" + B + "*," + B + "*"), X = new RegExp("^" + B + "*([>+~]|" + B + ")" + B + "*"), U = new RegExp("=" + B + "*([^\\]'\"]*?)" + B + "*\\]","g"), V = new RegExp($), J = new RegExp("^" + R + "$"), Y = {
            ID: new RegExp("^#(" + P + ")"),
            CLASS: new RegExp("^\\.(" + P + ")"),
        ...
        }, G = /^(?:input|select|textarea|button)$/i, Q = /^h\d$/i, K = /^[^{]+\{\s*\[native \w/, Z = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ee = /[+~]/, te = /'|\\/g, ne = new RegExp("\\\\([\\da-f]{1,6}" + B + "?|(" + B + ")|.)","ig");
        try {
        ...
        function re(e, t, n, r) {
            var i, o, a, s, l, u, c;
            if ((t ? t.ownerDocument || t : N) !== T && g(t),
            n = n || [],
            !e || "string" != typeof e)
                return n;
            if (1 !== (i = (t = t || T).nodeType) && 9 !== i)
                return [];
            if (y && !r) {
                if (u = Z.exec(e))
                    if (c = u[1]) {
                        if (9 === i) {
                            ...
                            if (s.id === c)
                                return n.push(s),
                                n
                        } else if (t.ownerDocument && (s = t.ownerDocument.getElementById(c)) && b(t, s) && s.id === c)
                            return n.push(s),
                            n
                    } else {
                        if (u[2])
                        ...
                        if ((c = u[3]) && d.getElementsByClassName && t.getElementsByClassName)
                            return q.apply(n, t.getElementsByClassName(c)),
                            n
                    }
                if (d.qsa && (!v || !v.test(e))) {
                    if (l = s = C,
        ...
        g = re.setDocument = function(e) {
            var l = e ? e.ownerDocument || e : N
              , e = l.defaultView;
            return l !== T && 9 === l.nodeType && l.documentElement ? (r = (T = l).documentElement,
            y = !t(l),
            ...
            x.find.CLASS = d.getElementsByClassName && function(e, t) {
                if (typeof t.getElementsByClassName !== D && y)
            ...
            b = e || K.test(r.contains) ? function(e, t) {
            ...
            : function(e, t) {
                ...
                if (!i || !o)
                    return e === l ? -1 : t === l ? 1 : i ? -1 : o ? 1 : u ? O.call(u, e) - O.call(u, t) : 0;
                if (i === o)
                    return le(e, t);
        ...
        re.matchesSelector = function(e, t) {
            if ((e.ownerDocument || e) !== T && g(e),
            t = t.replace(U, "='$1']"),
            d.matchesSelector && y && (!i || !i.test(t)) && (!v || !v.test(t)))
                try {
                    var n = a.call(e, t);
        ...
        (x = re.selectors = {
            ...
            filter: {
                ...
                CHILD: function(p, e, t, h, m) {
                    ...
                    : function(e, t, n) {
                        var r, i, o, a, s, l, u = g != y ? "nextSibling" : "previousSibling", c = e.parentNode, f = v && e.nodeName.toLowerCase(), d = !n && !v;
                        if (c) {
                            if (g) {
                                for (; u; ) {
                                    for (o = e; o = o[u]; )
                                        if (v ? o.nodeName.toLowerCase() === f : 1 === o.nodeType)
                                            return !1;
                            ...
                            } else if (d && (r = (e[C] || (e[C] = {}))[p]) && r[0] === E)
                                a = r[1];
                            else
                                for (; (o = ++s && o && o[u] || (a = s = 0) || l.pop()) && ((v ? o.nodeName.toLowerCase() !== f : 1 !== o.nodeType) || !++a || (d && ((o[C] || (o[C] = {}))[p] = [E, a]),
                                o !== e)); )
                                    ;
            ...
            oe(function(e, t, n, r) {
                var i, o, a, s = [], l = [], u = t.length, c = e || function(e, t, n) {
                    for (var r = 0, i = t.length; r < i; r++)
                        re(e, t[r], n);
                    return n
                }(h || "*", n.nodeType ? [n] : n, []), f = !p || !e && h ? c : me(c, s, p, n, r), d = m ? y || (e ? p : u || g) ? [] : t : f;
                if (m && m(f, d, n, r),
                g)
                    for (i = me(d, l),
                    g(i, [], n, r),
                ...
                if (e) {
                    if (y || p) {
                        ...
                        for (o = d.length; o--; )
                            (a = d[o]) && -1 < (i = y ? O.call(e, a) : s[o]) && (e[i] = !(t[i] = a))
                    }
                } else
        ...
        function ye(g, y) {
            function e(e, t, n, r, i) {
                var o, a, s, l = 0, u = "0", c = e && [], f = [], d = w, p = e || b && x.find.TAG("*", i), h = E += null == d ? 1 : Math.random() || .1, m = p.length;
        ...
        p = re.tokenize = function(e, t) {
            var n, r, i, o, a, s, l, u = S[e + " "];
            if (u)
                return t ? 0 : u.slice(0);
            for (a = e,
            s = [],
            l = x.preFilter; a; ) {
                for (o in n && !(r = I.exec(a)) || (r && (a = a.slice(r[0].length) || a),
                s.push(i = [])),
                n = !1,
                ...
                a = a.slice(n.length)),
                x.filter)
                    !(r = Y[o].exec(a)) || l[o] && !(r = l[o](r)) || (n = r.shift(),
                    i.push({
                        value: n,
                        type: o,
                        matches: r
        ...
        m = re.select = function(e, t, n, r) {
            ...
            1 === c.length) {
                ...
                !x.relative[s = a.type]); )
                    if ((l = x.find[s]) && (r = l(a.matches[0].replace(ne, f), ee.test(o[0].type) && ce(t.parentNode) || t))) {
                        if (o.splice(i, 1),
                        !(e = r.length && de(o)))
                            return q.apply(n, r),
                            n;
    ...
    w.fn.extend({
        ...
        is: function(e) {
            return !!T(this, "string" == typeof e && v.test(e) ? w(e) : e || [], !1).length
        }
    });
    var C = h.document
      , N = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/;
    (w.fn.init = function(e, t) {
        ...
        if ("string" != typeof e)
            ...
            this.length = 1,
            this) : w.isFunction(e) ? void 0 !== E.ready ? E.ready(e) : e(w) : (void 0 !== e.selector && (this.selector = e.selector,
            this.context = e.context),
            w.makeArray(e, this));
        if (!(n = "<" === e.charAt(0) && ">" === e.charAt(e.length - 1) && 3 <= e.length ? [null, e, null] : N.exec(e)) || !n[1] && t)
            return (!t || t.jquery ? t || E : this.constructor(t)).find(e);
        if (n[1]) {
            if (t = t instanceof w ? t[0] : t,
            w.merge(this, w.parseHTML(n[1], t && t.nodeType ? t.ownerDocument || t : C, !0)),
            b.test(n[1]) && w.isPlainObject(t))
                for (n in t)
                    w.isFunction(this[n]) ? this[n](t[n]) : this.attr(n, t[n]);
            return this
        }
    ...
    w.extend({
        dir: function(e, t, n) {
            for (var r = [], i = e[t]; i && 9 !== i.nodeType && (void 0 === n || 1 !== i.nodeType || !w(i).is(n)); )
    ...
    w.fn.extend({
        ...
        closest: function(e, t) {
            for (var n, r = 0, i = this.length, o = [], a = v.test(e) || "string" != typeof e ? w(e, t || this.context) : 0; r < i; r++)
    ...
    w.each({
        ...
        w.fn[r] = function(e, t) {
            ...
            1 < this.length && (S[r] || (n = w.unique(n)),
    ...
    var D, j = /\S+/g, L = {};
    function H() {
        C.addEventListener ? (C.removeEventListener("DOMContentLoaded", _, !1),
        h.removeEventListener("load", _, !1)) : (C.detachEvent("onreadystatechange", _),
    ...
    w.extend({
        ...
        when: function(e) {
            ...
            var i, n, r, o = 0, a = c.call(arguments), s = a.length, l = 1 !== s || e && w.isFunction(e.promise) ? s : 0, u = 1 === l ? e : w.Deferred();
            if (1 < s)
                for (i = new Array(s),
                n = new Array(s),
                r = new Array(s); o < s; o++)
                    a[o] && w.isFunction(a[o].promise) ? a[o].promise().done(t(o, r, a)).fail(u.reject).progress(t(o, n, i)) : --l;
    ...
    w.extend({
        ...
        ready: function(e) {
            if (!0 === e ? !--w.readyWait : !w.isReady) {
                ...
                (w.isReady = !0) !== e && 0 < --w.readyWait || (D.resolveWith(C, [w]),
                w.fn.triggerHandler && (w(C).triggerHandler("ready"),
                w(C).off("ready")))
            }
        }
    }),
    w.ready.promise = function(e) {
        if (!D)
            ...
            "complete" === C.readyState)
                ...
                C.addEventListener("DOMContentLoaded", _, !1),
    ...
    w(function() {
        ...
        n && n.style && (e = C.createElement("div"),
        (t = C.createElement("div")).style.cssText = "position:absolute;border:0;width:0;height:0;top:0;left:-9999px",
        n.appendChild(t).appendChild(e),
        typeof e.style.zoom !== M && (e.style.cssText = "display:inline;margin:0;border:0;padding:1px;width:1px;zoom:1",
    ...
    function R(e, t, n, r) {
        if (w.acceptData(e)) {
            var i, o = w.expando, a = e.nodeType, s = a ? w.cache : e, l = a ? e[o] : e[o] && o;
            if (l && s[l] && (r || s[l].data) || void 0 !== n || "string" != typeof t)
                return s[l = l || (a ? e[o] = f.pop() || w.guid++ : o)] || (s[l] = a ? {} : {
                    toJSON: w.noop
                }),
    ...
    function W(e, t, n) {
        if (w.acceptData(e)) {
            var r, i, o = e.nodeType, a = o ? w.cache : e, s = o ? e[w.expando] : w.expando;
            if (a[s]) {
                if (t && (r = n ? a[s] : a[s].data)) {
                    i = (t = w.isArray(t) ? t.concat(w.map(t, w.camelCase)) : t in r || (t = w.camelCase(t))in r ? [t] : t.split(" ")).length;
                    for (; i--; )
                        delete r[t[i]];
                    if (n ? !P(r) : !w.isEmptyObject(r))
                        return
                }
                (n || (delete a[s].data,
                P(a[s]))) && (o ? w.cleanData([e], !0) : y.deleteExpando || a != a.window ? delete a[s] : a[s] = null)
            }
        }
    }
    w.extend({
    ...
    w.fn.extend({
        data: function(e, t) {
            ...
            if (this.length && (i = w.data(o),
            1 === o.nodeType && !w._data(o, "parsedAttrs"))) {
                for (n = a.length; n--; )
                    a[n] && 0 === (r = a[n].name).indexOf("data-") && B(o, r = w.camelCase(r.slice(5)), i[r]);
    ...
    w.extend({
        queue: function(e, t, n) {
            var r;
            if (e)
                return r = w._data(e, t = (t || "fx") + "queue"),
    ...
    w.fn.extend({
        ...
        promise: function(e, t) {
            ...
            e = void 0),
            e = e || "fx"; s--; )
                (r = w._data(a[s], e + "queueHooks")) && r.empty && (i++,
                r.empty.add(n));
            return n(),
            o.promise(t)
        }
    ...
    !function() {
        ...
        y.html5Clone = "<:nav></:nav>" !== C.createElement("nav").cloneNode(!0).outerHTML,
        e.type = "checkbox",
        e.checked = !0,
        n.appendChild(e),
    ...
    function() {
        ...
        for (e in {
            ...
            (y[e + "Bubbles"] = (t = "on" + e)in h) || (n.setAttribute(t, "t"),
    ...
    w.event = {
        ...
        add: function(e, t, n, r, i) {
            var o, a, s, l, u, c, f, d, p, h = w._data(e);
            if (h)
            ...
            if (g && (c = g.events)) {
                for (u = (t = (t || "").match(j) || [""]).length; u--; )
                    ...
                    p) {
                        ...
                        l && !d.length && (f.teardown && !1 !== f.teardown.call(e, h, g.handle) || w.removeEvent(e, p, g.handle),
                        delete c[p])
                    } else
                        for (p in c)
                            w.event.remove(e, p + t[u], n, r, !0);
                w.isEmptyObject(c) && (delete g.handle,
                w._removeData(e, "events"))
            }
        },
        trigger: function(e, t, n, r) {
            var i, o, a, s, l, u, c = [n || C], f = g.call(e, "type") ? e.type : e, d = g.call(e, "namespace") ? e.namespace.split(".") : [], p = l = n = n || C;
            if (3 !== n.nodeType && 8 !== n.nodeType && !G.test(f + w.event.triggered) && (0 <= f.indexOf(".") && (f = (d = f.split(".")).shift(),
            d.sort()),
            o = f.indexOf(":") < 0 && "on" + f,
            (e = e[w.expando] ? e : new w.Event(f,"object" == typeof e && e)).isTrigger = r ? 2 : 3,
            e.namespace = d.join("."),
            ...
            r || !s.trigger || !1 !== s.trigger.apply(n, t))) {
                if (!r && !s.noBubble && !w.isWindow(n)) {
                    ...
                    G.test(a + f) || (p = p.parentNode); p; p = p.parentNode)
                        c.push(p),
                        l = p;
                ...
                for (u = 0; (p = c[u++]) && !e.isPropagationStopped(); )
                    ...
                    (i = (w._data(p, "events") || {})[e.type] && w._data(p, "handle")) && i.apply(p, t),
                    (i = o && p[o]) && i.apply && w.acceptData(p) && (e.result = i.apply(p, t),
                    !1 === e.result && e.preventDefault());
                if (e.type = f,
                !r && !e.isDefaultPrevented() && (!s._default || !1 === s._default.apply(c.pop(), t)) && w.acceptData(n) && o && n[f] && !w.isWindow(n)) {
                    (l = n[o]) && (n[o] = null),
                    w.event.triggered = f;
                    try {
                        n[f]()
        ...
        dispatch: function(e) {
            ...
            !l.preDispatch || !1 !== l.preDispatch.call(this, e)) {
                for (o = w.event.handlers.call(this, e, s),
                t = 0; (r = o[t++]) && !e.isPropagationStopped(); )
                    ...
                    i = 0; (n = r.handlers[i++]) && !e.isImmediatePropagationStopped(); )
                        ...
                        e.data = n.data,
                        void 0 !== (n = ((w.event.special[n.origType] || {}).handle || n.handler).apply(r.elem, a)) && !1 === (e.result = n) && (e.preventDefault(),
                        e.stopPropagation()));
            ...
            if (s && l.nodeType && (!e.button || "click" !== e.type))
                for (; l != this; l = l.parentNode || this)
                    if (1 === l.nodeType && (!0 !== l.disabled || "click" !== e.type)) {
                        for (i = [],
                        o = 0; o < s; o++)
                            void 0 === i[n = (r = t[o]).selector + " "] && (i[n] = r.needsContext ? 0 <= w(n, this).index(l) : w.find(n, this, null, [l]).length),
                            i[n] && i.push(r);
                        i.length && a.push({
                            elem: l,
                            handlers: i
        ...
        mouseHooks: {
            ...
            filter: function(e, t) {
                ...
                return null == e.pageX && null != t.clientX && (r = (n = e.target.ownerDocument || C).documentElement,
                n = n.body,
        ...
        special: {
            ...
            click: {
                trigger: function() {
                    if (w.nodeName(this, "input") && "checkbox" === this.type && this.click)
                        return this.click(),
                        !1
                },
                _default: function(e) {
    ...
    : function(e, t, n) {
        t = "on" + t;
        e.detachEvent && (typeof e[t] === M && (e[t] = null),
        e.detachEvent(t, n))
    }
    ,
    ...
    w.each({
        ...
        w.event.special[e] = {
            ...
            handle: function(e) {
                ...
                return n && (n === this || w.contains(this, n)) || (e.type = r.origType,
    ...
    y.changeBubbles || (w.event.special.change = {
        setup: function() {
            if (V.test(this.nodeName))
                return "checkbox" !== this.type && "radio" !== this.type || (w.event.add(this, "propertychange._change", function(e) {
    ...
    y.focusinBubbles || w.each({
        ...
        w.event.special[r] = {
            ...
            teardown: function() {
                var e = this.ownerDocument || this
                  , t = w._data(e, r) - 1;
                t ? w._data(e, r, t) : (e.removeEventListener(n, i, !0),
                w._removeData(e, r))
            }
        }
    }),
    ...
    function ye(e, t) {
        ...
        if (!o)
            ...
            n = e.childNodes || e; null != (r = n[i]); i++)
                !t || w.nodeName(r, t) ? o.push(r) : w.merge(o, ye(r, t));
    ...
    function Ce(e, t) {
        if (1 === t.nodeType && w.hasData(e)) {
            var n, r, i, o = w._data(e), e = w._data(t, o), a = o.events;
            if (a)
                ...
                a)
                    for (r = 0,
                    i = a[n].length; r < i; r++)
                        w.event.add(t, n, a[n][r]);
            e.data && (e.data = w.extend({}, e.data))
        }
    }
    ...
    w.extend({
        clone: function(e, t, n) {
            ...
            if (y.html5Clone || w.isXMLDoc(e) || !ie.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (ge.innerHTML = e.outerHTML,
            ge.removeChild(o = ge.firstChild)),
            !(y.noCloneEvent && y.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || w.isXMLDoc(e)))
                for (r = ye(o),
                s = ye(e),
                a = 0; null != (i = s[a]); ++a)
                    r[a] && function(e, t) {
                        ...
                        if (1 === t.nodeType) {
                            ...
                            !y.noCloneEvent && t[w.expando]) {
                                for (r in (i = w._data(t)).events)
                            ...
                            y.html5Clone && e.innerHTML && !w.trim(t.innerHTML) && (t.innerHTML = e.innerHTML)) : "input" === n && U.test(e.type) ? (t.defaultChecked = t.checked = e.checked,
        ...
        buildFragment: function(e, t, n, r) {
            for (var i, o, a, s, l, u, c, f = e.length, d = te(t), p = [], h = 0; h < f; h++)
                if ((o = e[h]) || 0 === o)
                    if ("object" === w.type(o))
                        ...
                        i = c[0]; i--; )
                            s = s.lastChild;
                        if (!y.leadingWhitespace && oe.test(o) && p.push(t.createTextNode(oe.exec(o)[0])),
                        !y.tbody)
                            for (i = (o = "table" !== l || le.test(o) ? "<table>" !== c[1] || le.test(o) ? 0 : s : s.firstChild) && o.childNodes.length; i--; )
                                w.nodeName(u = o.childNodes[i], "tbody") && !u.childNodes.length && o.removeChild(u);
                        for (w.merge(p, s.childNodes),
            ...
            y.appendChecked || w.grep(ye(p, "input"), ve),
            h = 0; o = p[h++]; )
                if ((!r || -1 === w.inArray(o, r)) && (a = w.contains(o.ownerDocument, o),
        ...
        cleanData: function(e, t) {
            for (var n, r, i, o, a = 0, s = w.expando, l = w.cache, u = y.deleteExpando, c = w.event.special; null != (n = e[a]); a++)
                if ((t || w.acceptData(n)) && (o = (i = n[s]) && l[i])) {
                    if (o.events)
                        for (r in o.events)
                            c[r] ? w.event.remove(n, r) : w.removeEvent(n, r, o.handle);
                    l[i] && (delete l[i],
                    u ? delete n[s] : typeof n.removeAttribute !== M ? n.removeAttribute(s) : n[s] = null,
                    f.push(i))
                }
        }
    }),
    w.fn.extend({
        ...
        remove: function(e, t) {
            for (var n, r = e ? w.filter(e, this) : this, i = 0; null != (n = r[i]); i++)
                t || 1 !== n.nodeType || w.cleanData(ye(n)),
                n.parentNode && (t && w.contains(n.ownerDocument, n) && Te(ye(n, "script")),
                n.parentNode.removeChild(n));
            return this
        },
        empty: function() {
            for (var e, t = 0; null != (e = this[t]); t++) {
                for (1 === e.nodeType && w.cleanData(ye(e, !1)); e.firstChild; )
        ...
        html: function(e) {
            return X(this, function(e) {
                ...
                if ("string" == typeof e && !ce.test(e) && (y.htmlSerialize || !ie.test(e)) && (y.leadingWhitespace || !oe.test(e)) && !me[(se.exec(e) || ["", ""])[1].toLowerCase()]) {
                    e = e.replace(ae, "<$1></$2>");
                    try {
                        for (; n < r; n++)
        ...
        domManip: function(n, r) {
            n = m.apply([], n);
            var e, t, i, o, a, s, l = 0, u = this.length, c = this, f = u - 1, d = n[0], p = w.isFunction(d);
            ...
            e)) {
                for (i = (o = w.map(ye(s, "script"), xe)).length; l < u; l++)
                    t = s,
                    l !== f && (t = w.clone(t, !0, !0),
                    i && w.merge(o, ye(t, "script"))),
                    r.call(this[l], t, l);
                if (i)
    ...
    w.each({
        ...
        w.fn[e] = function(e) {
            for (var t, n = 0, r = [], i = w(e), o = i.length - 1; n <= o; n++)
    ...
    function Ae(e) {
        var t = C
          , n = ke[e];
        return n || ("none" !== (n = Se(e, t)) && n || ((t = ((Ne = (Ne || w("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement))[0].contentWindow || Ne[0].contentDocument).document).write(),
        t.close(),
        n = Se(e, t),
        Ne.detach()),
        ke[e] = n),
    ...
    ;
    var De, je, Le, He, _e, qe, Me = /^margin/, Oe = new RegExp("^(" + z + ")(?!px)[a-z%]+$","i"), Fe = /^(top|right|bottom|left)$/;
    function Be(t, n) {
        return {
            get: function() {
                var e = t();
    ...
    function Pe() {
        var e, t, n, r = C.getElementsByTagName("body")[0];
        r && r.style && (e = C.createElement("div"),
        (t = C.createElement("div")).style.cssText = "position:absolute;border:0;width:0;height:0;top:0;left:-9999px",
        ...
        Le = He = !1,
        qe = !0,
        h.getComputedStyle && (Le = "1%" !== (h.getComputedStyle(e, null) || {}).top,
        He = "4px" === (h.getComputedStyle(e, null) || {
            width: "4px"
        }).width,
        (n = e.appendChild(C.createElement("div"))).style.cssText = e.style.cssText = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:0",
        n.style.marginRight = n.style.width = "0",
        e.style.width = "1px",
        qe = !parseFloat((h.getComputedStyle(n, null) || {}).marginRight)),
    ...
    ,
    je = function(e, t, n) {
        var r, i = e.style, o = (n = n || De(e)) ? n.getPropertyValue(t) || n[t] : void 0;
        return n && ("" !== o || w.contains(e.ownerDocument, e) || (o = w.style(e, t)),
        Oe.test(o) && Me.test(t) && (r = i.width,
        e = i.minWidth,
        t = i.maxWidth,
    ...
    y.opacity = "0.5" === rt.opacity,
    y.cssFloat = !!rt.cssFloat,
    nt.style.backgroundClip = "content-box",
    nt.cloneNode(!0).style.backgroundClip = "",
    y.clearCloneStyle = "content-box" === nt.style.backgroundClip,
    y.boxSizing = "" === rt.boxSizing || "" === rt.MozBoxSizing || "" === rt.WebkitBoxSizing,
    w.extend(y, {
    ...
    function Je(e, t) {
        if (t in e)
            return t;
        for (var n = t.charAt(0).toUpperCase() + t.slice(1), r = t, i = Ve.length; i--; )
            if ((t = Ve[i] + n)in e)
                return t;
        return r
    }
    function Ye(e, t) {
        for (var n, r, i, o = [], a = 0, s = e.length; a < s; a++)
            (r = e[a]).style && (o[a] = w._data(r, "olddisplay"),
            n = r.style.display,
            t ? (o[a] || "none" !== n || (r.style.display = ""),
            "" === r.style.display && $(r) && (o[a] = w._data(r, "olddisplay", Ae(r.nodeName)))) : (i = $(r),
            (n && "none" !== n || !i) && w._data(r, "olddisplay", i ? n : w.css(r, "display"))));
        for (a = 0; a < s; a++)
    ...
    function Qe(e, t, n, r, i) {
        for (var o = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0, a = 0; o < 4; o += 2)
            "margin" === n && (a += w.css(e, n + I[o], !0, i)),
            r ? ("content" === n && (a -= w.css(e, "padding" + I[o], !0, i)),
            "margin" !== n && (a -= w.css(e, "border" + I[o] + "Width", !0, i))) : (a += w.css(e, "padding" + I[o], !0, i),
            "padding" !== n && (a += w.css(e, "border" + I[o] + "Width", !0, i)));
        return a
    }
    function Ke(e, t, n) {
        var r = !0
        ...
        if (i <= 0 || null == i) {
            if (((i = je(e, t, o)) < 0 || null == i) && (i = e.style[t]),
            Oe.test(i))
                return i;
    ...
    w.extend({
        ...
        style: function(e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var i, o, a, s = w.camelCase(t), l = e.style;
                if (t = w.cssProps[s] || (w.cssProps[s] = Je(l, s)),
                a = w.cssHooks[t] || w.cssHooks[s],
                void 0 === n)
                    return a && "get"in a && void 0 !== (i = a.get(e, !1, r)) ? i : l[t];
                if ("string" === (o = typeof n) && (i = Ie.exec(n)) && (n = (i[1] + 1) * i[2] + parseFloat(w.css(e, t)),
                o = "number"),
                null != n && n == n && ("number" !== o || w.cssNumber[s] || (n += "px"),
    ...
    w.each(["height", "width"], function(e, i) {
        w.cssHooks[i] = {
            get: function(e, t, n) {
                if (t)
                    return $e.test(w.css(e, "display")) && 0 === e.offsetWidth ? w.swap(e, Xe, function() {
                        return Ke(e, i, n)
                    }) : Ke(e, i, n)
            },
            set: function(e, t, n) {
    ...
    y.opacity || (w.cssHooks.opacity = {
        ...
        set: function(e, t) {
            ...
            ((n.zoom = 1) <= t || "" === t) && "" === w.trim(e.replace(Re, "")) && n.removeAttribute && (n.removeAttribute("filter"),
            "" === t || r && !r.filter) || (n.filter = Re.test(e) ? e.replace(Re, i) : e + " " + i)
        }
    }),
    ...
    w.fx.step = {};
    var et, tt, nt, rt, it = /^(?:toggle|show|hide)$/, ot = new RegExp("^(?:([+-])=|)(" + z + ")([a-z%]*)$","i"), at = /queueHooks$/, st = [function(t, e, n) {
        var r, i, o, a, s, l, u, c = this, f = {}, d = t.style, p = t.nodeType && $(t), h = w._data(t, "fxshow");
        ...
        u = w.css(t, "display"),
        "inline" === ("none" === u ? w._data(t, "olddisplay") || Ae(t.nodeName) : u) && "none" === w.css(t, "float") && (y.inlineBlockNeedsLayout && "inline" !== Ae(t.nodeName) ? d.zoom = 1 : d.display = "inline-block"));
        ...
        if (w.isEmptyObject(f))
            ...
            for (r in h ? "hidden"in h && (p = h.hidden) : h = w._data(t, "fxshow", {}),
            o && (h.hidden = !p),
            p ? w(t).show() : c.done(function() {
                w(t).hide()
            }),
            c.done(function() {
                for (var e in w._removeData(t, "fxshow"),
                f)
                    w.style(t, e, f[e])
            }),
            f)
    ...
    function dt(i, e, t) {
        var n, o, r = 0, a = st.length, s = w.Deferred().always(function() {
            delete l.elem
        }), l = function() {
            if (o)
                return !1;
    ...
    w.fn.extend({
        ...
        finish: function(a) {
            return !1 !== a && (a = a || "fx"),
            this.each(function() {
                var e, t = w._data(this), n = t[a + "queue"], r = t[a + "queueHooks"], i = w.timers, o = n ? n.length : 0;
                for (t.finish = !0,
                w.queue(this, a, []),
    ...
    w.fn.extend({
        val: function(t) {
            var n, e, r, i = this[0];
            return arguments.length ? (r = w.isFunction(t),
            ...
            select: {
                get: function(e) {
                    for (var t, n = e.options, r = e.selectedIndex, i = "select-one" === e.type || r < 0, o = i ? null : [], a = i ? r + 1 : n.length, s = r < 0 ? a : i ? r : 0; s < a; s++)
                        if (((t = n[s]).selected || s === r) && (y.optDisabled ? !t.disabled : null === t.getAttribute("disabled")) && (!t.parentNode.disabled || !w.nodeName(t.parentNode, "optgroup"))) {
                            if (t = w(t).val(),
                            i)
                                return t;
                            o.push(t)
                ...
                set: function(e, t) {
                    for (var n, r, i = e.options, o = w.makeArray(t), a = i.length; a--; )
                        if (r = i[a],
                        0 <= w.inArray(w.valHooks.option.get(r), o))
                            try {
                                r.selected = n = !0
                            } catch (e) {
                                r.scrollHeight
    ...
    w.each(["radio", "checkbox"], function() {
        w.valHooks[this] = {
            set: function(e, t) {
                if (w.isArray(t))
                    return e.checked = 0 <= w.inArray(w(e).val(), t)
            }
        },
    ...
    var ht, mt, gt = w.expr.attrHandle, yt = /^(?:checked|selected)$/i, vt = y.getSetAttribute, bt = y.input;
    w.fn.extend({
        attr: function(e, t) {
    ...
    w.extend({
        attr: function(e, t, n) {
            ...
            if (e && 3 !== o && 8 !== o && 2 !== o)
                return typeof e.getAttribute === M ? w.prop(e, t, n) : (1 === o && w.isXMLDoc(e) || (t = t.toLowerCase(),
                r = w.attrHooks[t] || (w.expr.match.bool.test(t) ? mt : ht)),
                void 0 === n ? !(r && "get"in r && null !== (i = r.get(e, t))) && null == (i = w.find.attr(e, t)) ? void 0 : i : null !== n ? r && "set"in r && void 0 !== (i = r.set(e, n, t)) ? i : (e.setAttribute(t, n + ""),
    ...
    w.each(w.expr.match.bool.source.match(/\w+/g), function(e, t) {
        ...
        : function(e, t, n) {
            if (!n)
                return e[w.camelCase("default-" + t)] ? t.toLowerCase() : null
        }
    }),
    ...
    y.hrefNormalized || w.each(["href", "src"], function(e, t) {
        w.propHooks[t] = {
            get: function(e) {
    ...
    w.fn.extend({
        addClass: function(t) {
            ...
            if (u)
                for (e = (t || "").match(j) || []; s < l; s++)
                    if (r = 1 === (n = this[s]).nodeType && (n.className ? (" " + n.className + " ").replace(Tt, " ") : " ")) {
                        for (o = 0; i = e[o++]; )
                            r.indexOf(" " + i + " ") < 0 && (r += i + " ");
                        a = w.trim(r),
        ...
        toggleClass: function(i, t) {
            ...
            return "boolean" == typeof t && "string" == o ? t ? this.addClass(i) : this.removeClass(i) : w.isFunction(i) ? this.each(function(e) {
                ...
                if ("string" == o)
                    for (var e, t = 0, n = w(this), r = i.match(j) || []; e = r[t++]; )
                        n.hasClass(e) ? n.removeClass(e) : n.addClass(e);
                else
                    o !== M && "boolean" != o || (this.className && w._data(this, "__className__", this.className),
                    this.className = !this.className && !1 !== i && w._data(this, "__className__") || "")
            })
        },
        hasClass: function(e) {
            for (var t = " " + e + " ", n = 0, r = this.length; n < r; n++)
                if (1 === this[n].nodeType && 0 <= (" " + this[n].className + " ").replace(Tt, " ").indexOf(t))
                    return !0;
            return !1
        }
    }),
    ...
    ;
    var kt, St, At = /#.*$/, Dt = /([?&])_=[^&]*/, jt = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm, Lt = /^(?:GET|HEAD)$/, Ht = /^\/\//, _t = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, qt = {}, Mt = {}, Ot = "*/".concat("*");
    try {
        St = location.href
    } catch (e) {
    ...
    w.extend({
        ...
        ajax: function(e, t) {
            "object" == typeof e && (t = e,
            e = void 0);
            var n, l, u, c, f, d, r, p = w.ajaxSetup({}, t = t || {}), h = p.context || p, m = p.context && (h.nodeType || h.jquery) ? w(h) : w.event, g = w.Deferred(), y = w.Callbacks("once memory"), v = p.statusCode || {}, i = {}, o = {}, b = 0, a = "canceled", x = {
                readyState: 0,
            ...
            if (g.promise(x).complete = y.add,
            x.success = x.done,
            x.error = x.fail,
            p.url = ((e || p.url || St) + "").replace(At, "").replace(Ht, kt[1] + "//"),
            p.type = t.method || t.type || p.method || p.type,
            p.dataTypes = w.trim(p.dataType || "*").toLowerCase().match(j) || [""],
            null == p.crossDomain && (e = _t.exec(p.url.toLowerCase()),
            p.crossDomain = !(!e || e[1] === kt[1] && e[2] === kt[2] && (e[3] || ("http:" === e[1] ? "80" : "443")) === (kt[3] || ("http:" === kt[1] ? "80" : "443")))),
            p.data && p.processData && "string" != typeof p.data && (p.data = w.param(p.data, p.traditional)),
            Bt(qt, p, t, x),
            2 === b)
                return x;
            for (n in (f = p.global) && 0 == w.active++ && w.event.trigger("ajaxStart"),
            p.type = p.type.toUpperCase(),
            p.hasContent = !Lt.test(p.type),
            l = p.url,
            p.hasContent || (p.data && (l = p.url += (Nt.test(l) ? "&" : "?") + p.data,
            delete p.data),
            !1 === p.cache && (p.url = Dt.test(l) ? l.replace(Dt, "$1_=" + Ct++) : l + (Nt.test(l) ? "&" : "?") + "_=" + Ct++)),
            p.ifModified && (w.lastModified[l] && x.setRequestHeader("If-Modified-Since", w.lastModified[l]),
            w.etag[l] && x.setRequestHeader("If-None-Match", w.etag[l])),
            ...
            function s(e, t, n, r) {
                ...
                r ? (p.ifModified && ((n = x.getResponseHeader("Last-Modified")) && (w.lastModified[l] = n),
                (n = x.getResponseHeader("etag")) && (w.etag[l] = n)),
                ...
                x.status = e,
                x.statusText = (t || s) + "",
                r ? g.resolveWith(h, [i, s, x]) : g.rejectWith(h, [x, s, o]),
                x.statusCode(v),
                v = void 0,
                f && m.trigger(r ? "ajaxSuccess" : "ajaxError", [x, p, r ? i : o]),
                y.fireWith(h, [x, s]),
    ...
    w.fn.extend({
        wrapAll: function(t) {
            ...
            }) : (this[0] && (e = w(t, this[0].ownerDocument).eq(0).clone(!0),
    ...
    w.param = function(e, t) {
        ...
        var r, i = [];
        if (void 0 === t && (t = w.ajaxSettings && w.ajaxSettings.traditional),
    ...
    w.ajaxTransport("script", function(t) {
        if (t.crossDomain) {
            var r, i = C.head || w("head")[0] || C.documentElement;
            return {
                send: function(e, n) {
    ...
    w.ajaxPrefilter("json jsonp", function(e, t, n) {
        ...
        if (a || "jsonp" === e.dataTypes[0])
            return r = e.jsonpCallback = w.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback,
    ...
    w.parseHTML = function(e, t, n) {
        ...
        var r = b.exec(e)
          , n = !n && [];
        return r ? [t.createElement(r[1])] : (r = w.buildFragment([e], t, n),
    ...
    w.fn.load = function(e, t, n) {
        if ("string" != typeof e && Gt)
            return Gt.apply(this, arguments);
        var r, i, o, a = this, s = e.indexOf(" ");
        return 0 <= s && (r = w.trim(e.slice(s, e.length)),
        e = e.slice(0, s)),
        w.isFunction(t) ? (n = t,
    ...
    w.offset = {
        setOffset: function(e, t, n) {
            var r, i, o, a, s = w.css(e, "position"), l = w(e), u = {};
            "static" === s && (e.style.position = "relative"),
            o = l.offset(),
            r = w.css(e, "top"),
            a = w.css(e, "left"),
            a = ("absolute" === s || "fixed" === s) && -1 < w.inArray("auto", [r, a]) ? (i = (s = l.position()).top,
    ...
    w.fn.extend({
        offset: function(t) {
            ...
            w.contains(e, r) ? (typeof r.getBoundingClientRect !== M && (n = r.getBoundingClientRect()),
            i = Kt(i),
            {
        ...
        position: function() {
            if (this[0]) {
                ...
                return "fixed" === w.css(r, "position") ? t = r.getBoundingClientRect() : (e = this.offsetParent(),
                t = this.offset(),
                (n = !w.nodeName(e[0], "html") ? e.offset() : n).top += w.css(e[0], "borderTopWidth", !0),
        ...
        offsetParent: function() {
            return this.map(function() {
                for (var e = this.offsetParent || Qt; e && !w.nodeName(e, "html") && "static" === w.css(e, "position"); )
                    e = e.offsetParent;
                return e || Qt
            })
        }
    ...
    w.each({
        ...
        w.each({
            ...
            w.fn[e] = function(e, t) {
                ...
                return X(this, function(e, t, n) {
                    var r;
                    return w.isWindow(e) ? e.document.documentElement["client" + o] : 9 === e.nodeType ? (r = e.documentElement,
                    Math.max(e.body["scroll" + o], r["scroll" + o], e.body["offset" + o], r["offset" + o], r["client" + o])) : void 0 === n ? w.css(e, t, i) : w.style(e, t, n, i)
                }, a, n ? e : void 0, n, null)
            }
        })
    }),
