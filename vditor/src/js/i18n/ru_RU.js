window.VditorI18n = {
  ...
  'aiUpdateGoal': 'Цель улучшения',
  'aiUpdateGoalPlaceholder': 'Опишите, что хотите улучшить (необязательно)...',
  ...
  'aiPolishBtn': 'Улучшить',
  'aiCustomModels': 'Свои модели',
  'aiNoModels': 'Моделей нет',
  'aiAddModel': 'Добавить модель',
  'aiModelName': 'Название',
  'aiSelectModel': 'Выбрать модель',
  'aiNoModelSelected': '— Выбрать модель —',
  ...
  'aiInputPanelPlaceholder': 'Спросить ИИ или ввести / для команды',
  'aiInputPanelSend': 'Отправить',
  'aiInputPanelStop': 'Остановить',
  'aiCategoryRewrite': 'ИИ-правка',
  'aiBeta': 'Beta',
  'aiInput': 'ИИ-помощь',
  'aiBlockMenuInput': 'ИИ-помощь',
  'aiPresetContinue': 'Продолжить',
  'aiPresetCowrite': 'Совместное',
  'aiPresetRewrite': 'Переписать',
  'aiPresetSynonym': 'Синонимы',
  'aiPolishFormat': 'Формат',
  'aiPolishTone': 'Тон',
  'aiPolishDetail': 'Подробность',
}
