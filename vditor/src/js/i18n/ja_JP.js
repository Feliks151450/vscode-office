window.VditorI18n = {
  ...
  'boldColorPurple': '紫',
  'boldColorTeal': 'ティール',
  'aiInputPanelPlaceholder': 'AI に質問、または / でコマンド起動',
  'aiInputPanelSend': '送信',
  'aiInputPanelStop': '停止',
  'aiCategoryRewrite': 'AI で編集',
  'aiBeta': 'Beta',
  'aiInput': 'AI ヘルプ',
  'aiBlockMenuInput': 'AI ヘルプ',
  'aiPresetContinue': '続きを書く',
  'aiPresetCowrite': '共同執筆',
  'aiPresetRewrite': '書き直す',
  'aiPresetSynonym': '類語に置換',
  'aiPolishFormat': '書式',
  'aiPolishTone': 'トーン',
  'aiPolishDetail': '詳細度',
}
